...
async function postUpdateToLocation(accessToken: string, accountId: string, locationId: string, postData: LocalPostRequestBody) {
...
const postData: LocalPostRequestBody = {
  languageCode: "en-US",
  summary: "Exciting News! We are launching a new product this weekend. Stay tuned!",
  callToAction: {
