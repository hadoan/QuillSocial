    ...
    <div className="bg-emphasis flex h-screen">
      <div className="bg-default m-auto rounded p-10">
        <div className="flex flex-row">
          ...
          <div className="ml-5">
            <div className="text-md text-default">How to route a Typeform with QuillAI Routing</div>
            <ol className="mb-5 ml-5 mt-5 list-decimal ltr:mr-5 rtl:ml-5">
              ...
              <li>Create a Typeform that you want to route through QuillAI form&apos;s routing</li>
              <li>
              ...
              <li>
                You&apos;re set! Now, when the Typeform gets responses they would be routed through QuillAI
                routing
              </li>
            </ol>
