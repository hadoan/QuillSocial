      ...
      <div className="bg-default m-auto rounded p-10">
        <div className="flex flex-row">
          <div className="mr-5">
            <img
              className="w-11"
              src="/api/app-store/typeform/icon.svg"
              alt="Zapier Logo"
            />
          </div>
          <div className="ml-5">
            <div className="text-md text-default">
              How to route a Typeform with QuillAI Routing
            </div>
            <ol className="mb-5 ml-5 mt-5 list-decimal ltr:mr-5 rtl:ml-5">
              <li>
                Make sure that you have{" "}
                <Link
                  href="/apps/routing-forms"
              ...
              <li>
                Create a Routing Form with fields on the basis of which you want
                your typeform routing to work
              </li>
              <li>
                <Link
              ...
              <li>
                Create a Typeform that you want to route through QuillAI
                form&apos;s routing
              </li>
              <li>
              ...
              <li>
                You&apos;re set! Now, when the Typeform gets responses they
                would be routed through QuillAI routing
              </li>
            </ol>
