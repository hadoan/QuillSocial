...
const Wrapper = ({
  ...
  <div tw="flex w-full h-full">
    <img
      ...
      src={`${MY_APP_URL}/social-bg-${variant}-lines.jpg`}
      alt="background"
      width="1200"
      height="600"
    />
    ...
    <div tw="flex relative">
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `url(${MY_APP_URL}${visualSlug})`,
...
export const App = ({ name, description, slug }: AppImageProps) => (
  <Wrapper>
    ...
    <div tw="flex items-center w-full">
      <div tw="flex">
        <img src={`${MY_APP_URL}${slug}`} alt="App icon" width="172" />
      </div>
    </div>
...
export const Generic = ({ title, description }: GenericImageProps) => (
  <Wrapper>
    <div tw="h-full flex flex-col justify-start">
      ...
      <div tw="relative flex text-[54px] w-full flex-col text-emphasis mt-auto">
        <div tw="flex w-[1040px]" style={{ fontFamily: "quill" }}>
          {title}
        </div>
