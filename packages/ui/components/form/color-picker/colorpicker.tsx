...
import { fallBackHex, isValidHexCode } from "@quillsocial/lib/getBrandColours";
import { Button } from "@quillsocial/ui";
import { RotateCcw } from "@quillsocial/ui/components/icon";
  ...
  return (
    <div className="mt-1 flex h-[38px] items-center justify-center">
      ...
      {resetDefaultValue && color != resetDefaultValue && (
        <div className="px-1">
          <Button
            color={resetDefaultValue == "#000004" ? "primary" : "secondary"}
            target="_blank"
            variant="icon"
            rel="noreferrer"
            StartIcon={RotateCcw}
