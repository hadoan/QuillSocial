...
import { applyStyleToMultipleVariants } from "@quillsocial/lib/cva";
  ...
  "inline-flex items-center text-sm font-medium relative rounded-md transition-colors",
  {
    ...
    compoundVariants: [
      ...
      ...applyStyleToMultipleVariants({
        ...
        color: "primary",
        className:
          "bg-awst hover:bg-awsthv rounded hover:border-awsthv focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset focus-visible:ring-brand-default text-brand",
      }),
      {
        disabled: true,
        color: "primary",
