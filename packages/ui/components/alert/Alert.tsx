    ...
    >
      <div className="relative flex md:flex-row">
        {CustomIcon ? (
          ...
          <div className="flex-shrink-0">
            {severity === "error" && (
              <XCircle
                className={classNames(
                  "h-5 w-5 text-red-900 dark:text-red-200",
                  iconClassName
                )}
                aria-hidden="true"
              />
            ...
            {severity === "warning" && (
              <AlertTriangle
                className={classNames(
                  "text-attention h-5 w-5 dark:text-orange-200",
                  iconClassName
                )}
                aria-hidden="true"
              />
            ...
            {severity === "info" && (
              <Info
                className={classNames(
                  "h-5 w-5 text-blue-900 dark:text-blue-200",
                  iconClassName
                )}
                aria-hidden="true"
              />
            ...
            {severity === "neutral" && (
              <Info
                className={classNames(
                  "text-default h-5 w-5 fill-transparent",
                  iconClassName
                )}
                aria-hidden="true"
              />
            ...
            {severity === "success" && (
              <CheckCircle2
                className={classNames(
                  "fill-muted text-default h-5 w-5",
                  iconClassName
                )}
                aria-hidden="true"
              />
        ...
        <div className="flex flex-grow flex-col sm:flex-row">
          ...
          {props.actions && (
            <div className="ml-auto mt-2 text-sm sm:mt-0 md:relative">
              {props.actions}
            </div>
          )}
        </div>
