import type { AppImageProps, MeetingImageProps } from "@quillsocial/lib/OgImages";
import { constructAppImage, constructGenericImage, constructMeetingImage } from "@quillsocial/lib/OgImages";
...
import { seoConfig, getSeoImage, buildCanonical } from "@quillsocial/lib/next-seo.config";
...
export const HeadSeo = (props: HeadSeoProps): JSX.Element => {
  ...
  const isCalcom =
    url && (new URL(url).hostname.endsWith("quillsocial.co") || new URL(url).hostname.endsWith("app.quillsocial.co"));
