...
interface PluginProps {
    ...
    onPluginAfterChange: (value: { time: string; timeType: string; comment: string }) => void;
}
...
const Plugin: React.FC<PluginProps> = ({
    ...
    const [selectedTimeType, setSelectedTimeType] = useState(timeTypeOption[0].value);
    ...
    const handleCommentChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        onPluginAfterChange({ time, timeType: selectedTimeType, comment: newComment });
    };
        ...
        <div className="flex pl-[50px] text-sm justify-start items-start flex-col">
            ...
            <div className="flex gap-2">
                ...
                <Select
                    ...
                    onChange={(selectedOption) => handleTimeTypeChange(selectedOption as { value: string })}
                />
            </div>
            <EmojiDialog
                open={isModalEmoji}
