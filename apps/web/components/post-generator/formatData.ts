export const allFormat = [
  ...
  {
    content:
      "I started [doing x], and here's what happened\n\n→ 1. [outcome 1]\n\n- [how 1]\n- [how 2]\n- [how 3]\n\n→ 2. [outcome 2]\n\n- [how 1]\n- [how 2]\n- [how 3]\n\n→ 3. [outcome 3]\n\n- [how 1]\n- [how 2]\n- [how 3]\n\n→ 4. [outcome 4]\n\n- [how 1]\n- [how 2]\n- [how 3]\n\nThat's it\n\nPS Ask me anything about [X].",
  },
  {
    content:
      "The old way vs. the new way of {Topic}\n\nOld way\n• {Way1}\n• {Way2}\n• {Way3}\n• {Way4}\n\nNew Way\n• {Way1}\n• {Way2}\n• {Way3}\n• {Way4}\n\nThe shift?\n\n{New} > {Old}\n\n{Call to Action}",
  },
  {
    content:
...
export const StartScratch = [{ content: "" }];

export const ArticlePost = [{ content: "" }];
