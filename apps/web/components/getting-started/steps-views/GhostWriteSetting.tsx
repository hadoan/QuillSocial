...
const GhostWriteSetting = () => {
    ...
    const onSubmit = handleSubmit((data: { description: string, speakAbout:string }) => {
        setIsLoading(true); 
        ...
        <form onSubmit={onSubmit}>
            <div className="flex flex-row items-center justify-center ">
                <div className="flex items-center flex-col px-4">
                    <span className="text-subtle flex text-[20px] font-bold"> QuillAI Setting
                    <img className="ml-2" src="/icon_sparkling.png"></img>
                    </span>
                    <span className="text-subtle font-normal">Config your AI QuillAI setting and preference.</span>
                </div>
            </div>
                    ...
                    label={
                        <>
                            <div className="flex flex-col">
                                ...
                                <span className="text-subtle font-normal">Short overview of you - a unique Linkedln headline is enough</span>
                            </div>
                        </>
                    }
                />
                    ...
                    label={
                        <>
                            <div className="flex flex-col">
                                ...
                                <span className="text-subtle font-normal">The key topics you frequently write about - separated by comma</span>
                            </div>
                        </>
                    }
                />
