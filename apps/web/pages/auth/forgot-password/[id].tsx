    ...
    return (
      <>
        <div className="space-y-6">
          <div>
            <h2 className="font-quill text-emphasis mt-6 text-center text-3xl font-extrabold">
              {t("password_updated")}
            </h2>
          </div>
          <Button href="/auth/login" className="w-full justify-center text-white">
            {t("login")}
          </Button>
        </div>
      </>
  ...
  const Expired = () => {
    return (
      <>
        <div className="space-y-6">
          <div>
            <h2 className="font-quill text-emphasis mt-6 text-center text-3xl font-extrabold">{t("whoops")}</h2>
