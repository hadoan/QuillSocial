            ...
            <div className={classNames("my-4 transition-opacity sm:my-0", " inset-0")} aria-hidden="true">
              <div
                ...
                <div className="mb-8 mt-6 text-center last:mb-0">
                  ...
                  <div className="mt-3">
                    <p className="text-default">We are thrilled to have you join the QuillAI community! 🍜</p>
                  </div>
                  ...
                  <div className="border-subtle text-default mt-8  grid grid-cols-3 border-t pt-8 text-center">
                    <div className="col-span-3 font-medium">
                      ...
                      <a href="mailto:team@workramen.com">hi@quillai.social</a>. Your feedback is invaluable to
                      us. Welcome aboard! 🎉
                    </div>
