      ...
      <main className="mx-auto">
        <div className="overflow-y-auto">
          <div
            ...
            <div className={classNames("my-4 transition-opacity sm:my-0", " inset-0")} aria-hidden="true">
              <div
                className={classNames(
                ...
                <div className="mb-8 mt-6 text-center last:mb-0">
                  ...
                  <div className="border-subtle text-default mt-8  grid grid-cols-3 border-t pt-8 text-center">
                    <div className="col-span-3 font-medium">
                      Get ready to unlock a world of productivity right at your fingertips.{" "}
                    </div>
                    <div className="col-span-3 mb-6 mt-2 last:mb-0">
                      Connect with us on social media to stay updated on all things QuillAI. Let's make work
                      more fulfilling and enjoyable together!{" "}
                    </div>
                  </div>

                  <div className="border-subtle text-default mt-8  grid grid-cols-3 border-t pt-8 text-center">
                    <div className="col-span-3 font-medium">
                      If you have any questions or suggestions, don't hesitate to reach out at{" "}
                      <a href="mailto:ha@quillai.social">ha@quillai.social</a>. Your feedback is invaluable
                      to us. Welcome aboard! 🎉
                    </div>
